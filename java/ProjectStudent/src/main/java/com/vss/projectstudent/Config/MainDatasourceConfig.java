package com.vss.projectstudent.Config;
...
@EnableJpaRepositories(
        basePackages = "com.vss.projectstudent",
...
public class MainDatasourceConfig {
    ...
    mainEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                .dataSource(mainDatasource())
                .packages("com.vss.projectstudent.Model")
                .build();
    }
